...
class CMPNN(nn.Module):
    ...
    """
    def __init__(self, hidden_features, output_features, num_step_message_passing=3):
        super(CMPNN, self).__init__()
        
        self.num_step_message_passing = num_step_message_passing

        self.node_emb = AtomEncoder(emb_dim=hidden_features)
        
        self.edge_emb = BondEncoder(emb_dim=hidden_features)
    ...
    def forward(self, graphs, devices):
        node_features, edge_features = graphs.ndata['feat'], graphs.edata['feat']
