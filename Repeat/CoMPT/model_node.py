...
class Generator(nn.Module):
    ...
    def forward(self, x, mask):
        # [batch, max_length, hidden_features] -> [batch, max_length, output_features]
        return self.proj(x * repeat(mask, 'b m -> b m c', c=x.shape[-1]))


class CoMPT(nn.Module):
    def __init__(self, hidden_features=64, output_features=1,
