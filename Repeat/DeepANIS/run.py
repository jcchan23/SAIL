...
if __name__ == '__main__':
    ...
    # load total dataset
    with open(f'{args.data_path}/total_277.pickle', 'rb') as f:
    ...
    # model
    model = DeepANIS(args.node_features_dim, args.hidden_features_dim, args.output_features_dim).to(device)
