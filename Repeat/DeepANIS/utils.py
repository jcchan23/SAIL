...
def cal_metric(y_true, y_pred, best_threshold=None):
    ...
    if best_threshold is None:
        fpr, tpr, thresholds = metrics.roc_curve(concatenate_true, concatenate_pred)
    ...
    return {'auroc': auroc,'auprc': auprc, 'mcc': mcc, 'f1':f1, 'threshold': best_threshold}
