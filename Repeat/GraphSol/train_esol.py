...
if __name__ == '__main__':
    ...
    # load total dataset
    with open(f'{args.data_path}/esol/esol_train.pickle', 'rb') as f:
    ...
    # initital weight and print model summary, GraphSol not need initialize
    ...
    with open(f'{args.result_path}/esol_seed_{args.seed}/{model.__class__.__name__}_fold_{args.run_fold}.txt', 'w') as f:
        ...
        for epoch in range(1, args.max_epochs + 1):
            ...
            # train stage
            model.train()
            train_results, _ = loop(train_loader, model, optimizer=optimizer, scheduler=scheduler, device=device)
