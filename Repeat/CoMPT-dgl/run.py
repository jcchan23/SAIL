...
if __name__ == '__main__':
    ...
    # model
    model = CoMPT(in_node_features=args.node_features_dim, in_edge_features=args.edge_features_dim, hidden_features=args.hidden_features_dim, output_features=args.task_number,
